...
import com.example.accident.InputValidation
import com.example.accident.R
...
class LoginActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun verifyFromSQLite() {
        ...
        if (databaseHelper!!.checkUser(textInputEditTextEmail!!.text.toString().trim { it <= ' ' }, textInputEditTextPassword!!.text.toString().trim { it <= ' ' })) {
            ...
            val accountsIntent = Intent(activity, LocationActivity::class.java)
    ...
    fun email(): String {
        initViews()
        return textInputEditTextEmail!!.text.toString().trim()
    }
